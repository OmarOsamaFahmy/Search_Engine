...
public class Helper {
  ...
  public static String htmlToFile(String link,String content,long id) throws SQLException, ClassNotFoundException {
     ...
     ;
        File f = null;
        String fileName = "/media/yomna/01D0FF6D5A7E01F0/3rd year/APT/pages/" +"page"+ new Long(id) + ".html";
        String path = "";
    ...
    public static String[] tokenise(String text) {
        ...
        String tokens[] = null;
        try {
            inputStream = new FileInputStream("/home/yomna/IdeaProjects/en-token.bin");
